					...
					session_start();
...

										{
													...
													if($br){
														...
														echo '<a> Welcome, ' . $_POST['username2'] .'</a>';
														...
														echo "<script type='text/javascript'>alert('NOT found this name');
											...
											echo "<script type='text/javascript'>alert('Not all fiel fill');
												...
												/* 		echo "<script type='text/javascript'>alert('Not login');
										  </script>";	 */					
													}
			...
			<div class="row">
				...
				<div class="slike"> 
					...
					<script>
						...
						slideshowlinks("ponuda-en.php?cat=1","ponuda-en.php?cat=2","ponuda-en.php?cat=3","ponuda-en.php?cat=4","ponuda-en.php?cat=5","ponuda-en.php?cat=6","ponuda-en.php?cat=7","ponuda-en.php?cat=8","ponuda-en.php?cat=9","ponuda-en.php?cat=10","ponuda-en.php?cat=11","ponuda-en.php?cat=12","ponuda-en.php?cat=13","ponuda-en.php?cat=14","ponuda-en.php?cat=15","ponuda-en.php?cat=16")
...
<!--NAJPRODAVANIJI PROIZVODI-->
				<?php
					...
					$result = mysqli_query($con,"SELECT * FROM proizvodien WHERE id IN (2,18,19,24) ");
					...
					{ 
						...
						.'<a href="ponuda-en.php"><img src="'.$row['slika'].'"></a><p>'.$row['opis'].'</p>'
						...
						echo	  '<button class="dodaj">Add in basket</button>'
