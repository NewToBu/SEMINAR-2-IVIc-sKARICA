...
if(!empty($_SESSION['cart'])){
	...
	$result = mysqli_query($con,"SELECT * FROM proizvodien WHERE id IN ($sto) ");
	...
	{ 
		...
		echo '<div class="proizvodiPO row">
												...
												<div class="column column-3 slikaUKosarici">
													<a href="ponuda-en.php"><img src="'.$row['slika'].'"></a>
													</div>
													<div class="column column-4">
													<h3>'.$row['ime'].'</h3>
													<h3>Amount:&nbsp&nbsp'.$kolicina.'</h3>
														<h3>Price:&nbsp&nbsp<strong>'.$cijena.',00USD</strong></h3>
														</div>
														
														<a href="ukloni-en.php?taj='.$row['id'].'"><div class="buttonUkloni column column-3">
														<h3> Delete </h3>
												</div></a>
	...
	echo '<div class="proizvodiUKL row">
									...
									<a href="isprazni-en.php?ro=66"><div class="buttonUkloni2 column column-3">
									<h3> Empty </h3>
									</div></a>
	...
	echo '
										...
										<div class="column column-4">
										<h3>Price: '.$ukupnaCijena.',00USD</h3>
											</div>';
	...
	/*  if(!isset($_SESSION['pac'])){
									...
									echo "<script type='text/javascript'>alert('Molimo logirajte se');
	...
	echo	'<form id = "pay" action = "narudba-en.php" method = "post">
	        <input type="hidden" name="narudba" value="'.$nar.'" />
             <button class="buttonKupi column column-3"><h3> Buy </h3></button>
												</form>
